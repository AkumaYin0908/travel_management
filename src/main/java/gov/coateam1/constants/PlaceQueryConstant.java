...
public interface PlaceQueryConstant {
    ...
    String FIND_BY_CODES = "select * from place where building_name = ?" +
            " and (barangay_code is null or barangay_code = ?) and municipality_code =? and province_code = ? and region_code = ?";
